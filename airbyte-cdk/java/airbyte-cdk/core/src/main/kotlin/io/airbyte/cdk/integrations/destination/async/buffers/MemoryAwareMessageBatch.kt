...
/**
 * POJO abstraction representing one discrete buffer read. This allows ergonomics dequeues by {@link
 * io.airbyte.cdk.core.destination.aysnc.FlushWorkers}. <p> The contained stream **IS EXPECTED to be
 * a BOUNDED** stream. Returning a boundless stream has undefined behaviour.
 *
